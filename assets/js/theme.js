...
(function ($) {
    ...
    circle_progress.each(function () {
      ...
      $(this)
        ...
        .on("circle-animation-progress", function (event, progress) {
          $(this)
            .find("strong")
            .html(parseInt(decs * progress) + "<span>%</span>");
        });
    });
  }
  ...
  if (google_map.length > 0) {
    ...
    var styles = [
      ...
      },
      {
        ...
        stylers: [{ saturation: 1 }, { weight: 0.1 }, { color: "#53575b" }],
      },
    ];
    map.addStyle({
  ...
  var revapi2 = jQuery("#rev_slider_2")
    .show()
    .revolution({
      delay: 9000,
      responsiveLevels: [1200, 1140, 778, 480],
  ...
  var revapi3 = jQuery("#rev_slider_3")
    .show()
    .revolution({
      delay: 9000,
  ...
  var revapi4 = jQuery("#rev_slider_4")
    .show()
    .revolution({
      delay: 9000,
      responsiveLevels: [1200, 1140, 778, 480],
  ...
  var revapi5 = jQuery("#rev_slider_5")
    .show()
    .revolution({
      delay: 9000,
      responsiveLevels: [1200, 1140, 778, 480],
  ...
  var revapi6 = jQuery("#rev_slider_6")
    .show()
    .revolution({
      delay: 9000,
      responsiveLevels: [1200, 1140, 778, 480],
  ...
  $("#contact_form").on("submit", function (e) {
    ...
    if (required === 0) {
      $.ajax({
        ...
        success: function (data) {
          ...
          $(".con_message", $this)
            .fadeIn()
            .html(
              "<strong>감사합니다!</strong> 담당자에게 메일이 전송되었습니다."
            )
      ...
      $(".con_message", $this)
        .fadeIn()
        .html(
          "<strong>죄송해요!</strong> 담당자에게 메일이 전송되지 않았습니다. 입력 사항을 모두 입력해 주세요."
        )
  ...
  // contact button responsible

  const nWidth = window.innerWidth;

  //var parentele = document.getElementsById("mainMenuul");
  if (nWidth < 990) {
    $("#mainMenuul").html(
      '<li><a class="rdls-underline2" href="about_us.html">ABOUT US</a></li><li><a class="rdls-underline2" href="service.html">SERVICE</a></li><li><a class="rdls-underline2" href="project.html">PROJECT</a></li><li><a class="rdls-underline2" href="contact_us.html">CONTACT</a></li>'
    );
  }
  if (nWidth < 990) {
    $("#mainMenuul1").html(
      '<li><a class="rdls-underline2" href="index.html">HOME</a></li><li><a class="rdls-underline2" href="about_us.html">ABOUT US</a></li><li><a class="rdls-underline2" href="service.html">SERVICE</a></li><li><a class="rdls-underline2" href="project.html">PROJECT</a></li><li><a class="rdls-underline2" href="contact_us.html">CONTACT</a></li>'
    );
  }
